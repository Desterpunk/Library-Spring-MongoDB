...
import com.sofkau.Library.usecases.ReturnResourceUseCase;
...
public class ReturnResourceRouter {
    ...
    public RouterFunction<ServerResponse> returnResource(ReturnResourceUseCase returnResourceUseCase){
        return route(GET("/library/return/{id}").and(accept(MediaType.APPLICATION_JSON)),
                request -> ServerResponse.ok()
                        .body(returnResourceUseCase.apply(request.pathVariable("id")), ResourceDTO.class));
    }
}
